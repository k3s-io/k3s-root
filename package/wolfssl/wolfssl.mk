...
WOLFSSL_CONF_OPTS = --disable-examples --disable-crypttests --enable-opensslall --enable-keygen --enable-rsapss --enable-des3 --enable-dtls \
 --enable-certgen --enable-certreq --enable-certext --enable-sessioncerts --enable-crl --enable-ocsp --enable-static
...
# constraint
ifeq ($(BR2_aarch64),y)
WOLFSSL_CONF_ENV += CPPFLAGS="$(TARGET_CPPFLAGS) -mstrict-align -DWOLFSSL_DES_ECB -DWOLFSSL_LOG_PRINTF -DWOLFSSL_PUBLIC_MP -DHAVE_EX_DATA"
endif
else
